...
#	--resume "/scratch/eo41/mae/models_vitl16/say_5fps_vitl16_checkpoint.pth" \
#	--batch_size_per_gpu 512 \
#	--num_workers 8 \
#	--lr 0.0003 \
#	--min_lr 0.0003 \
#	--weight_decay 0.0 \
#	--output_dir "/scratch/eo41/mae/models_vitl16" \
#	--data_path "/scratch/eo41/data/saycam/SAY_5fps_300s_{000000..000009}.tar" \
#	--save_prefix "say_5fps_vitl16"

#srun python -u /scratch/eo41/mae/train_mae.py \
#	--model 'mae_vit_large_patch16' \
#	--resume "/scratch/eo41/mae/models_vitl16/s_5fps_vitl16_checkpoint.pth" \
#	--batch_size_per_gpu 512 \
#	--num_workers 8 \
#	--lr 0.0003 \
#	--min_lr 0.0003 \
...
#srun python -u /scratch/eo41/mae/train_mae.py \
#	--model 'mae_vit_large_patch16' \
#	--resume "/scratch/eo41/mae/models_vitl16/a_5fps_vitl16_checkpoint.pth" \
#	--batch_size_per_gpu 512 \
#	--num_workers 8 \
#	--lr 0.0003 \
#	--min_lr 0.0003 \
...
#	--save_prefix "a_5fps_vitl16"
	
srun python -u /scratch/eo41/mae/train_mae.py \
	--model 'mae_vit_large_patch16' \
	--resume "/scratch/eo41/mae/models_vitl16/y_5fps_vitl16_checkpoint.pth" \
	--batch_size_per_gpu 512 \
	--num_workers 8 \
	--lr 0.0003 \
	--min_lr 0.0003 \

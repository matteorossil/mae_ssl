...
* To train an MAE model with a ViT-S/16 architecture on your data: 
```python
...
* To evaluate an MAE model with the linear probing approach: 
```python
...
* To evaluate an MAE model with the finetuning approach: 
```python
